...
- [Items API / Static HTML Webapp](https://github.com/MikeUchmanowicz/itemsAPIpythonStatic/) - *Python, FastAPI , Static Html + JavaScript, MongoDB, MySQL* 

  Created an Items API back end written in Python (FastAPI) which allows for the creating, reading, updating, and deleting of items. Items are stored within a Mongo DB. The front end has been built using HTML and javascript.
